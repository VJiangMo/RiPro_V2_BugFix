...
<div class="single-download-nav">
  <ul class="nav nav-pills" id="pills-tab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
      <a class="nav-link active" id="pills-details-tab" data-toggle="pill" href="#pills-details" role="tab" aria-controls="pills-details" aria-selected="true"><i class="far fa-file-alt mr-1"></i><?php _e( '详情介绍','ripro-v2' );?></a>
    </li>

    <?php if ( $is_comments_tab ) : ?>
    <li class="nav-item" role="presentation">
      <a class="nav-link" id="pills-comments-tab" data-toggle="pill" href="#pills-comments" role="tab" aria-controls="pills-comments" aria-selected="false"><i class="fa fa-comments-o mr-1"></i><?php _e( '评论建议','ripro-v2' );?></a>
    </li>
    <?php endif;?>

    <?php if ( $is_faq_tab ) : ?>
    <li class="nav-item" role="presentation">
      <a class="nav-link" id="pills-faq-tab" data-toggle="pill" href="#pills-faq" role="tab" aria-controls="pills-faq" aria-selected="false"><i class="far fa-question-circle mr-1"></i><?php _e( '常见问题','ripro-v2' );?></a>
    </li>
    <?php endif;?>
  ...
  <div class="tab-pane fade show active" id="pills-details" role="tabpanel" aria-labelledby="pills-details-tab">
    <article id="post-<?php the_ID(); ?>" <?php post_class('article-content'); ?>>
      <div class="container">
        ...
        <?php if ( !ripro_v2_show_hero() || $format=='video' ){
        ...
        <div class="entry-wrapper">
          ...
          <div class="entry-content u-text-format u-clearfix">
            <?php 
              ...
              if ($copyright = _cao('single_copyright')) { echo '<div class="post-note alert alert-warning mt-2" role="alert">' . $copyright . '</div>'; }
