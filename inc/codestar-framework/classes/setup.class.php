  ...
  class CSF {
    ...
    public static function add_admin_enqueue_scripts() {
      ...
      if ( apply_filters( 'csf_fa4', false ) ) {
        ...
        wp_enqueue_style( 'csf-fa5', get_template_directory_uri() . '/assets/font-awesome/css/all.min.css', array(), '5.15.5', 'all' );
        wp_enqueue_style( 'csf-fa5-v4-shims', get_template_directory_uri() . '/assets/font-awesome/css/v4-shims.min.css', array(), '5.15.5', 'all' );
      }
